package com.yoong.practice.mybatis.accidence.wong_user;
...
import com.yoong.practice.mybatis.accidence.wong_user.dao.AccountMapper;
...
public class WongUserManager {
    ...
    private static void wongUserTestByXml() {
        ...
        try {
            ...
            List<Account> result = session.selectList("com.yoong.practice.mybatis.accidence.wong_user.dao.AccountMapper.selectByExample", example);
