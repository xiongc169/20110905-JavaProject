package com.yoong.mybatis.accidence.yunyi;
...
import com.yoong.mybatis.accidence.yunyi.dao.NoticeMapper;
import com.yoong.mybatis.accidence.yunyi.domain.Accounts;
import com.yoong.mybatis.accidence.yunyi.domain.Notice;
import com.yoong.mybatis.accidence.yunyi.domain.NoticeExample;
...
public class YunyiManager {
    ...
    public static void yunyiTest() {
        ...
        try {
            ...
            Accounts accounts = session.selectOne("com.yoong.mybatis.accidence.yunyi.dao.AccountsMapper.selectByPrimaryKey", "201609191454299903499203");
