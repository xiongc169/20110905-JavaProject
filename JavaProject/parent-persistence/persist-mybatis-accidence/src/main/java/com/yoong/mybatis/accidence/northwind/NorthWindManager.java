package com.yoong.mybatis.accidence.northwind;
...
import com.yoong.mybatis.accidence.northwind.domain.Categories;
...
public class NorthWindManager {
    ...
    private static void northWindTest() {
        try {
            ...
            Categories result = session.selectOne("com.yoong.mybatis.accidence.northwind.dao.CategoriesMapper.selectByPrimaryKey", 28);
