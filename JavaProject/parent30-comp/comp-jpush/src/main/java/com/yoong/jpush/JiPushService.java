...
/**
 * @Desc 极光推送
 * https://blog.csdn.net/u014174854/article/details/78664589
 * <p>
 * @Author yoong
 * <p>
 * @Date 2018年8月9日
...
public class JiPushService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(JiPushService.class);
    ...
    private static PushPayload buildPushObject_ios_all_alertWithTitle(String notification_title, String msg_title, String msg_content, String extrasparam) {
        ...
        IosAlert laer = IosAlert.newBuilder().build();
