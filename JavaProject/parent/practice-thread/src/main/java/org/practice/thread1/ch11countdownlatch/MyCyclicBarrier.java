...
public class MyCyclicBarrier {
	...
	public static void main(String[] args) throws Exception {
		...
		final CyclicBarrier barrier = new CyclicBarrier(3, new Runnable() {
			...
			public void run() {
				System.out.println(df.format(new Date()) + " This is Runnable Begin " + Thread.currentThread().getId()
		...
		new Thread() {
			public void run() {
				try {
					System.out.println(df.format(new Date()) + " This is First Thread Begin "
		...
		new Thread() {
			public void run() {
				try {
					System.out.println(df.format(new Date()) + " This is Second Thread Begin "
							+ Thread.currentThread().getId() + " " + Thread.currentThread().getName());
					Thread.sleep(1000);
		...
		System.out.println(df.format(new Date()) + " This is main Thread Begin " + Thread.currentThread().getId() + " "
				+ Thread.currentThread().getName());
		// latch.await();
		barrier.await();
		System.out.println(df.format(new Date()) + " This is main Thread End " + Thread.currentThread().getId() + " "
				+ Thread.currentThread().getName());
